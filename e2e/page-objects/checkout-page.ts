...
export class CheckoutPage {
  ...
  // Navigation
  readonly checkoutUrl: string = '/checkout';
  ...
  readonly paymentMethodInstallment: Locator;
  readonly paymentMethodQRCode: Locator;
  ...
  readonly ktcMonthsSelect: Locator;
  readonly bayMonthsSelect: Locator;
  readonly fcyMonthsSelect: Locator;
  
  // Common elements
  readonly placeOrderButton: Locator;
  readonly orderTotal: Locator;
  readonly noticeContainer: Locator;
   ...
   */
  async selectPaymentMethod(method: 'creditcard' | 'installment' | 'qrcode'): Promise<void> {
    const methodMap = {
   ...
   */
  async fillCreditCardDetails(details: CreditCardDetails): Promise<void> {
   ...
   */
  async selectInstallmentBank(bank: 'KTC' | 'BAY' | 'FCY'): Promise<void> {
   ...
   */
  async selectInstallmentMonths(bank: 'KTC' | 'BAY' | 'FCY', months: string): Promise<void> {
   ...
   */
  async isCreditCardFormVisible(): Promise<boolean> {
   ...
   */
  async isInstallmentFormVisible(): Promise<boolean> {
   ...
   */
  async isQRCodeFormVisible(): Promise<boolean> {
   ...
   */
  async isPaymentMethodAvailable(method: 'creditcard' | 'installment' | 'qrcode'): Promise<boolean> {
    const methodMap = {
      creditcard: this.paymentMethodCreditCard,
      installment: this.paymentMethodInstallment,
      qrcode: this.paymentMethodQRCode
   ...
   */
  async waitForNoticesClear(): Promise<void> {
   ...
   */
  async isMinimumAmountWarningVisible(): Promise<boolean> {
   ...
   */
  async getAvailableMonths(bank: 'KTC' | 'BAY' | 'FCY'): Promise<string[]> {
    const monthsSelectors = {
      KTC: this.ktcMonthsSelect,
      BAY: this.bayMonthsSelect,
      FCY: this.fcyMonthsSelect
   ...
   */
  async checkInstallmentMinimum(bank: 'KTC' | 'BAY' | 'FCY', months: string): Promise<boolean> {
