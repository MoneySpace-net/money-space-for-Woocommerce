...
define('MS_API_URL_PREFIX', 'https://a.moneyspace.net');
define('MS_STATIC_URL_PREFIX', 'https://a.moneyspace.net/static');
...
define('MS_PAYMENT_JS', MS_STATIC_URL_PREFIX . '/moneyspace_payment.js');
...
if (in_array('woocommerce/woocommerce.php', $active_plugins)) {
    ...
    {
        $mylinks = array(
            '<a href="' . admin_url('admin.php?page=wc-settings&tab=checkout&section=moneyspace') . '">' . SETTING_LINK . '</a>',
        );
